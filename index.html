  ...
  <div class="card" id="card">
    ...
    <div class="card__topbar">
      <span class="card__brand">
        ...
        Adrien Terminal
        <span class="brand__underline"></span>
      </span>
        ...
        <div class="panel-view is-active" data-panel="projects">
          ...
          <div class="project-drawer" data-drawer="p1">
            <div class="drawer__inner">
              ...
              <button class="drawer-close" aria-label="Rabattre la page" title="Rabattre">
                <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M18 15l-6-6-6 6"/></svg>
                Fermer
              </button>
            </div>
          </div>
